...
import { ClipboardCheck, History, LayoutDashboard, LogOut } from "lucide-react"
...
const navItems = [
  ...
  { label: "Applications", href: "/officer/applications", icon: ClipboardCheck },
  { label: "Security Activity", href: "/officer/security-activity", icon: History },
]
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <aside className="fixed inset-y-0 left-0 hidden w-72 border-r border-slate-800 bg-slate-950 px-4 py-6 lg:block">
        <div className="mb-8 px-3">
          ...
          <h1 className="text-xl font-semibold">Officer Portal</h1>
